...
pub fn cast() -> Vec<Resident> {
    vec![
        Resident::new("res_hana", "Hana", 58, "Baker", "loc_bakery", vec![
            act("hana_sleep", "sleeps above the bakery", "HOME", 0, 1, 10, 4),
        ...
        Resident::new("res_sofia", "Sofia", 27, "Baker's assistant", "loc_main_square", vec![
            act("sofia_sleep", "sleeps in her room off the square", "HOME", 0, 1, 10, 5),
            ...
            act("sofia_home", "home to her room off the square", "HOME", 20, 4, 5, 2),
        ]),
        ...
        Resident::new("res_victor", "Victor", 63, "Retired footballer", "loc_cafe", vec![
            act("victor_sleep", "wakes slowly above the café", "HOME", 0, 1, 10, 6),
            ...
            act("victor_river", "a walk by the river", "WALK", 15, 4, 5, 2),
            act("victor_home", "home for the evening", "HOME", 20, 4, 7, 3),
        ]),
        Resident::new("res_elias", "Elias", 66, "Groundskeeper", "loc_main_square", vec![
            act("elias_sleep", "sleeps in his cottage by the square", "HOME", 0, 1, 10, 6),
            act("elias_work_am", "mows the pitch at first light", "WORK_GROUNDSKEEP", 7, 2, 9, 3),
            act("elias_coffee", "a quick coffee", "DRINK_COFFEE", 11, 3, 7, 1),
            act("elias_oak", "checks the old oak", "VISIT_OAK", 15, 3, 8, 2),
            act("elias_home", "home to his cottage by the square", "HOME", 20, 4, 6, 3),
        ]),
        Resident::new("res_eva", "Eva", 41, "Florist", "loc_main_square", vec![
            act("eva_sleep", "sleeps in her rooms by the square", "HOME", 0, 1, 10, 6),
            ...
            act("eva_home", "home to her rooms by the square", "HOME", 20, 4, 6, 3),
        ]),
        Resident::new("res_karim", "Karim", 34, "Kiosk vendor", "loc_main_square", vec![
            act("karim_sleep", "sleeps above the kiosk", "HOME", 0, 1, 10, 6),
            ...
            act("karim_home", "shutters the kiosk for the night", "HOME", 20, 4, 6, 3),
        ]),
        Resident::new("res_agnes", "Agnes", 81, "Retired supporter", "loc_main_square", vec![
            act("agnes_sleep", "sleeps in her rooms on the square", "HOME", 0, 1, 10, 6),
        ...
        Resident::new("res_milo", "Milo", 22, "Street musician", "loc_main_square", vec![
            ...
            act("milo_home", "home to his room by the square", "HOME", 21, 3, 5, 2),
        ]),
        Resident::new("res_tomas", "Tomas", 9, "Schoolchild", "loc_riverside", vec![
            act("tomas_sleep", "sleeps", "HOME", 0, 1, 10, 7),
