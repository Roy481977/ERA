...
Chooses among valid authored possibilities to manage pacing, attention, variety and emotional balance.
...
It never directly edits authoritative state or bypasses system rules.

## Dependencies

Reads all systems; acts only through requests to Event/Town/Narrative systems.
...
Every intervention can be explained as a permitted choice and replayed or disabled.
