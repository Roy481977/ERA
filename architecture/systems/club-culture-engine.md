# ERA — Club Culture Engine

**Status: PROPOSED.**

## Purpose

Owns traditions, symbols, chants, preferences, taboos, grudges, rituals and identity that emerge from repeated history.
...
It does not let the player directly author culture or let AI invent unsupported customs.

## Dependencies

Memory, Recognition, Relationships, Matchday, Narrative.
...
A repeated pattern becomes a tradition only after sufficient lived evidence.
