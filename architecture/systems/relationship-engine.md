# ERA — Relationship Engine

**Status: PROPOSED.**

## Purpose

Owns bonds, familiarity, trust, care, rivalry, resentment, obligations and relationship thresholds.
...
It does not write dialogue or force encounters.

## Dependencies

Time, Persistence, Events, Town.
...
Repeated encounters alter future behavior in bounded, explainable ways.
