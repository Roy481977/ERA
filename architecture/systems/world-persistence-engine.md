# ERA — World Persistence Engine

**Status: PROPOSED.**

## Purpose

Owns stable identities, authoritative state, event history, saves, migrations, rollback and recovery.
...
It does not interpret meaning or choose behavior.

## Dependencies

Time and schemas from every domain.
...
Reload any point in a test run and recover the same world with a traceable history.
